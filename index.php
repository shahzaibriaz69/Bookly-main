...
>>>>>>> a83c850c72c256730f145b5a4056003dd23c659a
  ...
  <section class="item-list container">
    ...
    <div class="featured-card">
      ...
      <div class="featured-item">
        <img src="images/product-item9.png" alt="Tales of the Enchanted Forest" />
        <div class="featured-info">
    ...
    <div class="card-slider">
      <div class="post-card">
        ...
        <div>
          <h5>books</h5>
          <a href="#">
            <h6>10 Must-Read Books of the Year: Our Top Picks!</h6>
          </a>
          <p>
      ...
      <div class="post-card">
        ...
        <div>
          <h5>books</h5>
          <a href="#">
            <h6>The Fascinating Realm of Science Fiction</h6>
          </a>
          <p>
            Dive into the world of cutting-edge technology with our latest
            blog post, where we highlight <a href="#">Read More</a>
      ...
      <div class="post-card">
        ...
        <div>
          <h5>books</h5>
          <a href="#">
            <h6>Finding Love in the Pages of a Book</h6>
          </a>
          <p>
            Dive into the world of cutting-edge technology with our latest
            blog post, where we highlight <a href="#">Read More</a>
  ...
  <div class="footer-bottom">
    <div class="container">
      <div style="
          ...
          ">
        <!-- Left side -->
        <div class="bot-footer-items">
          <div class="bot-footer-items">
            <p>We ship with:</p>
            <img class="footer-bottom-img" src="images/dhl.png" alt="DHL" />
            <img class="footer-bottom-img" src="images/shippingcard.png" alt="Shopping card" />
          </div>
          <div class="bot-footer-items">
            <p>Payment options:</p>
            <img class="footer-bottom-img" src="images/visa.jpg" alt="visa" />
            <img class="footer-bottom-img" src="images/mastercard.jpg" alt="mastercard" />
            <img class="footer-bottom-img" src="images/paypal.jpg" alt="paypal" />
          </div>
        </div>
        <!-- right side -->
        <div>
          <p class="footer-text">
            © Copyright 2024 Bookly. HTML Template by TemplatesJungle
          </p>
        </div>
      </div>
    </div>
